          ...
          <section className={styles.textForProject} aria-label="About and featured project">
            <h2 className={styles.sectionTitle}>EXPERIENCE</h2>
              <p className={styles.bodyText}>
                <b>[OCT '25 - Present]</b> 3D Software Engineer at SKAND <br />
            ...
            <p className={styles.bodyText}>
              I love anything to do with 3D graphics. From modelling a caterpillar to optimising 3D gaussian splat rendering. I love it all.
            </p>
          </section>
